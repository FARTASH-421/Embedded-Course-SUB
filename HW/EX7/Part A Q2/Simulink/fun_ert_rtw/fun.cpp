...
// Model step function
void fun_step(RT_MODEL_fun_T *const fun_M, real_T fun_U_SS, real_T fun_U_temp,
              real_T *fun_Y_V1, real_T *fun_Y_V2)
{
  DW_fun_T *fun_DW{ fun_M->dwork };

  // Chart: '<Root>/Fan' incorporates:
  //   Inport: '<Root>/SS'
  //   Inport: '<Root>/temp'
...
void fun_initialize(RT_MODEL_fun_T *const fun_M, real_T *fun_U_SS, real_T
