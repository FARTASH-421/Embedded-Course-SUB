...
// '<Root>/SS'
static real_T fun_U_SS;

// '<Root>/temp'
static real_T fun_U_temp;

// '<Root>/V1'
static real_T fun_Y_V1;

// '<Root>/V2'
static real_T fun_Y_V2;
...
void rt_OneStep(RT_MODEL_fun_T *const fun_M)
{
  ...
  // Step the model
  fun_step(fun_M, fun_U_SS, fun_U_temp, &fun_Y_V1, &fun_Y_V2);
...
int_T main(int_T argc, const char *argv[])
{
  ...
  // Initialize model
  fun_initialize(fun_M, &fun_U_SS, &fun_U_temp, &fun_Y_V1, &fun_Y_V2);
